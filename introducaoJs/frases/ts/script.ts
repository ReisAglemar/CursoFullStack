const frases: string[] = ["Mesmo quando o caminho parece confuso e cheio de incertezas, lembre-se de que Deus continua " +
...
function novaFrase(): void {

    const indice:number = Math.floor(Math.random() * 20);
    const paragrafo: HTMLElement =
        document.getElementById("frase") as HTMLElement;
